...
- `analysis_outputs/` - All analysis outputs are organized under this directory.
  ...
  - `logPCorrelationPlotsWithSEMMethodComparison/` - This directory contains plots similar to the `logPCorrelationPlotsWithSEM/` directory, except these compare the calculated log *P* of methods.
...
>>>>>>> 2b55fe5501cfbc4a662f02ad3e13df07944b4bfb
