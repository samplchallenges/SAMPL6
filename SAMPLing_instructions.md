...
- Other coversions are described in `SAMPLing/conversion.md`, as well as validations of the energies calculated at each configuration between programs.