...
- `SAMPLing/`: Equilibrated system files for the SAMPLing challenge. These include all host-guest systems in the SAMPL6 challenge with the exception of oxalipatin (CB8-G13). Files are available in Amber (`prmtop`/`rst7`), Gromacs (`top`/`gro`), OpenMM (`xml`) and PDB formats. See below for the setup protocol.
...
- The host-guest complex were solvated in a 12A buffer of TIP3P water molecules using tleap.
